...
BeeAI is hosted as an [incubation project](https://lfaidata.foundation/projects/) in the [LF AI & Data Foundation](https://lfaidata.foundation/).

## BeeAI authors
BeeAI is an open source project with an active development community. The project was started
by the Design and Incubation team in IBM Research.
...
1. Familiarize yourself with the [BeeAI contribution guidelines](CONTRIBUTING.md).
